...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query1 = "INSERT INTO empleados_roles (empleado_id,rol_id) VALUES ($empleado_id,$roles)";
    echo $query1;
